...
void Demo::Init(void)
{
	...
	Tiles::AddTileRow(Demo_Tiles3, TileType::Grass, test, TILE_WIDTTH, TILE_HEIGHT, AEVec2{ X, y3 });
	...
	sound.playAudio(soundTest[static_cast<int>(AudioID::BGM)], AudioID::BGM, true);
}
